# Form implementation generated from reading ui file '/home/rahal/Documents/GitHub/Image-Processing-Algorithms-Optimization/src/gui/mainwindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(39, 29, 1001, 657))
        ...
        self.processedImageLabel.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.AGCminimumSlider.valueChanged['int'].connect(self.AGCminimumRangeValue.setNum) # type: ignore
        self.AGCmaximumSlider.valueChanged['int'].connect(self.AGCmaximumRangeValue.setNum) # type: ignore
        self.algorithmsComboBox.currentIndexChanged['QString'].connect(self.AGCGroupBox.show) # type: ignore
