...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		MainWindow.setMinimumSize(QtCore.QSize(1500, 700))
		MainWindow.setMaximumSize(QtCore.QSize(1920, 1080))
		self.centralwidget = QtWidgets.QWidget(parent=MainWindow)
		self.centralwidget.setObjectName("centralwidget")
		self.gridLayoutWidget = QtWidgets.QWidget(parent=self.centralwidget)
		self.gridLayoutWidget.setGeometry(QtCore.QRect(58, 36, 1375, 600))
		...
		self.gridLayout_3.addWidget(self.processedImageLabel, 2, 1, 1, 1)

		# Parallel image label (right)
		...
		# Time label (row 5 — compareButton row is removed)
		...
		self.gridLayout_3.addWidget(self.timeLabel, 5, 0, 1, 3)
		...
		# ── Histogram Equalization group box ───────────────────────────────────
	...
	def retranslateUi(self, MainWindow):
		...
		self.AGCmaximumRangeValue.setText(_translate("MainWindow", "2"))
		self.applyAGCButton.setText(_translate("MainWindow", "Apply and Compare"))
		...
		self.applyGaussianBlurButton.setText(
			_translate("MainWindow", "Apply and Compare")
		)
		self.gammaLabel.setText(_translate("MainWindow", "Gamma:"))
		self.gammaValue.setText(_translate("MainWindow", "2.2"))
		self.applyGammaCorrectionButton.setText(
			_translate("MainWindow", "Apply and Compare")
		)
		self.meanKernelSizeLabel.setText(_translate("MainWindow", "Kernel size:"))
		self.applyMeanButton.setText(_translate("MainWindow", "Apply and Compare"))
		self.sepiaGammaLabel.setText(_translate("MainWindow", "Gamma:"))
		self.sepiaGammaValue.setText(_translate("MainWindow", "2.2"))
		self.applySepiaButton.setText(_translate("MainWindow", "Apply and Compare"))
		self.applyHEButton.setText(_translate("MainWindow", "Apply and Compare"))
		self.applySobelButton.setText(_translate("MainWindow", "Apply and Compare"))
